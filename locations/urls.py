...
from .views import (
    # Corridas
    CriarCorridaView, CorridaDetailView, AtualizarStatusCorridaView,
    CorridasDoPassageiroView, CorridasParaEcoTaxiView, CorridasEcoTaxiHistoricoView,
...
urlpatterns = [
    ...
    path('dispositivo/<uuid:uuid>/', DispositivoDetailView.as_view(), name='detalhar_dispositivo'),
    path('dispositivo/<uuid:uuid>/atualizar_nome/', AtualizarNomeDispositivoView.as_view(), name='atualizar_nome_dispositivo'),  # ⭐️
