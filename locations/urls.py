...
urlpatterns = [
    ...
    path('drivers/nearest/',    NearestDriverView.as_view(),       name='drivers-nearest'),
    
    path('ride/current/',       CurrentRideStatusView.as_view(),   name='ride-current-status'),
